package woven.video.storage.server.api.controllers.IT;
...
import woven.video.storage.server.api.controllers.VideoConversionController;
...
class VideoConversionControllerIT extends WithTestSetup {
    ...
    void scenario(String filePath) throws Exception {
        ...
        result = performList()
                ...
                .andExpect(jsonPath("$[0].status", is(not(Status.NOT_CONVERTED))))
                .andReturn();
